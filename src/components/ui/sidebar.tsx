  ...
  return (
    <Container fluid className="ps-0">
      <Style>
          ...
          <Col>
            <div className="d-flex justify-content-between align-items-center pt-3 pb-4">
              ...
              <div className="cursor-pointer">
                ...
                >
                  <path
                    d="M18.3083 13.3585V8.35848C18.3083 4.19181 16.6417 2.52515 12.475 2.52515H7.475C3.30833 2.52515 1.64166 4.19181 1.64166 8.35848V13.3585C1.64166 17.5251 3.30833 19.1918 7.475 19.1918H12.475C16.6417 19.1918 18.3083 17.5251 18.3083 13.3585Z"
                    stroke="#BEBEC8"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                  ...
                  />
                  <path
                    d="M12.475 8.72522L10.3417 10.8586L12.475 12.9919"
                    stroke="#BEBEC8"
                    strokeWidth="1.5"
                    strokeLinecap="round"
                    strokeLinejoin="round"
        ...
        <Row>
          <Dropdown className="my-24">
            <Dropdown.Toggle
              id="dropdown-basic"
              className="position-relative d-flex align-items-center bg-light border border-1 rounded-10 cursor-pointer pl-10 py-8 pr-16"
              as="div"
            >
              <Logo size={28} classes="ml-5" />
              <span className="fs-14 fw-bold mdss-mx-3 mx-1">Pivot Team</span>
