      ...
      <CardBody>
        ...
        <div className='d-flex align-items-center justify-content-between'>
          <div className='d-flex align-items-center'>
            ...
            <div className='rounded-circle position-relative' style={{right: '14px'}}>
              <img width={25} src='../../assets/images/json.png' />
            </div>
          </div>
          <div className='d-flex align-items-center'>
            <CircleProgress width={22} value={60} />{' '}
            <span className='fs-12 fw-bold ms-1'>{Math.floor(Math.random() * 60 + 1)}%</span>
          </div>
        </div>
      </CardBody>
    </Card>
